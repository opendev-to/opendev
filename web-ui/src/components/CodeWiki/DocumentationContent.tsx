...
// Extracted static `components` configuration object for ReactMarkdown outside the component.
// Creating this object inline on every render causes a new reference to be generated,
// triggering unnecessary deep re-renders of the entire markdown tree and all its children.
// By maintaining referential stability, we significantly improve rendering performance.
