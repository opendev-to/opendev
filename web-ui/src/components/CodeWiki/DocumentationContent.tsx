...
// Extracted markdown components outside the functional component to ensure referential stability.
// Creating this object inline causes React to generate a new object on every render,
// triggering unnecessary deep re-renders of the ReactMarkdown component and all its children.
const WIKI_MARKDOWN_COMPONENTS: import("react-markdown").Components = {
  h1: ({ children, ...props }) => (
    <h1
    ...
    <div className="max-w-4xl mx-auto px-8 py-8">
      ...
      <article className="prose prose-lg max-w-none">
        <ReactMarkdown
          ...
          components={WIKI_MARKDOWN_COMPONENTS}
        >
          {wikiPage.content}
        </ReactMarkdown>
      </article>
