...
// Isolating the high-frequency braille animation state updates into this component
// prevents layout thrashing and unnecessary deep re-renders in larger parent components
// like LandingPage and WelcomeScreen, which have expensive inputs and layout computations.
